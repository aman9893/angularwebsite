...
module.controller('aboutController', function($scope,$http) {
 
       $scope.message = 'This About page';

  $http({
    method : "GET",
    url : "webservice/json.php"
...
module.controller('SginupController', function($scope) {
